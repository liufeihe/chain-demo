...
import ChainDemoChaindemoChaindemo from './chain-demo/chaindemo.chaindemo'
...
export default { 
  ChainDemoChaindemoChaindemo: load(ChainDemoChaindemoChaindemo, 'chaindemo.chaindemo'),
