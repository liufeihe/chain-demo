 ...
 */
export interface ChaindemoQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: ChaindemoParams;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/chain-demo/chaindemo/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ChaindemoQueryParamsResponse, RpcStatus>({
      path: `/chain-demo/chaindemo/params`,
      method: "GET",
      format: "json",
      ...params,
    });
